...
const JAPAN_MEALS: IMeals[] = [
  ...
  { id: 4, name: 'Salmon salad', description: 'Rice, salmon,cucumber, chuka, nori, nut sauce', price: 16.30, img: meal_04 },
  ...
  { id: 8, name: 'Salmon salad', description: 'Rice, salmon,cucumber, chuka, nori, nut sauce', price: 16.30, img: meal_04 },
